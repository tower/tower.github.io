(function() {
  ...
  module.exports = function() {
    var args, compressor, debug, ignore, importPaths, options, outputPath, pathfinder, preprocess, touchDependencies, write, writeMethod;
      ...
      client: {
        ...
        update: function(data) {
          ...
          if (this.stylesheets[data.slug] != null) {
            this.stylesheets[data.slug].remove();
          }
          node = $("<style id='" + data.slug + "' type='text/css'>" + data.body + "</style>");
          this.stylesheets[data.slug] = node;
